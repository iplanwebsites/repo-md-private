...
import { DeploySiteTool } from '../tools/deploy-site.js';
import { ImportRssTool } from '../tools/import-rss.js';
import { SmartCrawlTool } from '../tools/smart-crawl.js';
import { ImportWordPressTool } from '../tools/import-wordpress.js';
import { MigrateGenericTool } from '../tools/migrate-generic.js';
import { MigrateMarkdownTool } from '../tools/migrate-markdown.js';
...
export function createToolRegistry(config: Config): Promise<ToolRegistry> {
  ...
  registerCoreTool(DeploySiteTool);
  registerCoreTool(ImportRssTool);
  registerCoreTool(SmartCrawlTool);
  registerCoreTool(ImportWordPressTool);
  registerCoreTool(MigrateGenericTool);
  registerCoreTool(MigrateMarkdownTool);
  return (async () => {
