---
title: "After 480 days uptime, lights out for old servicestack.net server"
date: 2012-08-30
---
...
It was a CentOS/Mono powered 2GB RAM dedicated server from [leaseweb](http://www.leaseweb.com/en) which we put to work to host the [servicestack.net](http://www.servicestack.net) domain (inc. all the live demos) as well as the other side projects I had running e.g: ajaxstack.com, freelamusica.com.
...
[![](images/OldServerRedisStats.png "Old Server Redis Stats")](http://ww2.servicestack.net/wp-uploads/2012/08/OldServerRedisStats.png)
