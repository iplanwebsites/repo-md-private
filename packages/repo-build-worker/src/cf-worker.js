// src/cf-worker.js
// Cloudflare Workers entry point for Container-based build processing
...
export class RepoBuildContainer extends Container {
  ...
  // Container will sleep after 5 minutes of inactivity to save resources
  sleepAfter = '5m';

  // Maximum execution time before container is forcefully stopped (10 minutes)
   ...
   */
  override onStart() {
    console.log('🚀 Build container started', {
      containerId: this.id,
