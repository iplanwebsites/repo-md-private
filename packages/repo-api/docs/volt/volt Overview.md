...
We're actively looking for community contributions to add fullStream support to other providers! If you're interested in helping, please check out our GitHub repository or join our Discord community.
...
llm: new VercelAIProvider(),
model: openai("gpt-4.1"), // Ensure model supports structured output/function calling
});
...
llm: new VercelAIProvider(),
model: openai("gpt-4.1"), // Models supporting tool use are required
...
model: openai("gpt-4.1"), // The specific model
});
