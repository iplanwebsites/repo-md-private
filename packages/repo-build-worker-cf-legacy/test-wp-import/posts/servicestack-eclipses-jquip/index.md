---
title: "ServiceStack eclipses jquip!"
date: 2013-02-24
---

This weekend I'm happy to find we passed an important internal milestone:

[![](images/servicestack-vs-jquip1.png "servicestack-vs-jquip")](https://github.com/mythz)

Where for the first time since its release, the 4+ year [ServiceStack](https://github.com/ServiceStack/ServiceStack) has finally surpassed my 3 week hobby js project [jquip](https://github.com/mythz/jquip) in followers!

### What's jquip?

For those that don't know, jquip is a [modularized version of jQuery](http://jquip.ubixar.com/) optimized to have the lightest footprint possible whilst retaining the most useful parts of jQuery. It's useful for bandwidth constrained environments where you don't want an external jQuery reference (e.g. widgets, offline stand-alone web app) but still want to code against a pleasant jQuery-like API. We use it in the [Careers 2.0 Apply Button widget](http://blog.stackoverflow.com/2012/03/enterprise-vs-consumer-development/) that can be hosted on external sites and provides faster start times by being able to execute straight after the in-lined jquip. Another area jquip has proven useful is to power [ServiceStack's built-in MiniProfiler](https://github.com/ServiceStack/ServiceStack/wiki/Built-in-profiling) Web UI allowing it to work in offline environments without internet access. Embedding the full version of jQuery would've significantly increased the size of ServiceStack.dll by more than 100kb. This lets you develop your own lightweight offline single page apps that have access [/ssr-jquip.all.js](http://bootstrapapi.apphb.com/api/ssr-jquip.all.js) using nothing other than a ServiceStack.dll :)
...
- **Contribute to existing .NET OSS projects:** Start with the ones you're already using otherwise here's the [leading list of C# projects on GitHub](https://github.com/languages/C%23/most_watched) you can work through.
...
- **Increase the collective knowledge around existing projects:** i.e. blog, submit talks, help out on [Stack Overflow](http://stackoverflow.com/), participate in mailing lists or [JabbR](https://jabbr.net/). If you or your team has spent a lot of time implementing a solution for a popular use-case consider blogging about it, providing insight to others following in a similar path.

Currently [C# stands as the 12th](https://github.com/languages/C%23) and [F# the 43rd](https://github.com/languages/F%23) most popular languages on GitHub (the home of OSS), it would be great to see if we can all beat these numbers next year!
